...
function TShirtBuilder({ frontBgImage, backBgImage, config: configProp, responsive: responsiveProp, onChange, onExport, className, style, initialImages }) {
    ...
    return (jsxs("div", { ref: wrapperRef, className: className, style: { ...wrapperStyle, ...style }, children: [error && (jsxs("div", { style: {
                    display: "flex",
                    alignItems: "center",
                    gap: "8px",
                    padding: "12px 16px",
                    ...
                    boxShadow: "0 2px 10px rgba(255, 0, 0, 0.1)"
                                ...
                                handleMobileImageInteraction();
                                                ...
                                                textAlign: "center"
                                                        ...
                                                        boxShadow: "0 2px 10px rgba(250, 192, 0, 0.3)",
                                                        transition: "all 0.3s ease-out"
                                                    }, children: "\u0418\u0437\u0431\u0435\u0440\u0438 \u0444\u0430\u0439\u043B" }), jsx("span", { style: { color: COLORS.GRAY, fontSize: "11px", marginTop: "12px" }, children: "PNG, JPG, WebP, GIF \u0434\u043E 10MB" })] }) })), displayConfig.printableArea && (jsx("div", { style: {
                                            position: "absolute",
