    ...
    return (jsxs("div", { ref: wrapperRef, className: className, style: { ...wrapperStyle, ...style }, children: [error && (jsxs("div", { style: {
                    ...
                    boxShadow: "0 2px 10px rgba(255, 0, 0, 0.1)"
                                ...
                                overflow: 'hidden'
                                        ...
                                        }, onDelete: deleteImage, onReorder: reorderImage, onAddImage: openFilePicker, currentView: currentView, onViewChange: setCurrentView, compact: true }) })] })) : (jsx(LayerPanel, { images: images, selectedId: selectedId, onSelect: (id) => {
                                selectImage(id);
                                handleMobileImageInteraction();
                            }, onDelete: deleteImage, onReorder: reorderImage, onAddImage: openFilePicker, currentView: currentView, onViewChange: setCurrentView, compact: false })) }), jsxs("div", { style: canvasColumnStyle, children: [jsxs("div", { ref: containerRef, style: containerStyle, onDrop: handleDrop, onDragOver: handleDragOver, onClick: handleContainerClick, children: [images.length === 0 && (jsx("div", { style: dropZoneStyle, children: jsxs("div", { style: {
                                                display: "flex",
                                                flexDirection: "column",
                                                alignItems: "center",
                                                padding: "32px",
                                        ...
                                        return (jsxs(React.Fragment, { children: [jsx("img", { src: imageData.src, alt: "\u041A\u0430\u0447\u0435\u043D \u0434\u0438\u0437\u0430\u0439\u043D", style: imageStyle, draggable: false, onPointerDown: e => {
                                                        ...
                                                        handleMobileImageInteraction();
                                                    }, onContextMenu: e => e.preventDefault() }), isSelected && (jsx(Controls, { transform: scaledTransform, allowRotation: displayConfig.allowRotation || false, onPointerDown: (e, mode, handle) => handlePointerDown(e, imageData.id, mode, handle) }))] }, imageData.id));
