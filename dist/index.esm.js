...
function Controls({ transform, allowRotation, onPointerDown, isMobile = false }) {
    ...
    const handlePointerDownWithFeedback = useCallback((e, mode, handle) => {
    ...
    return (jsxs("div", { style: containerStyle, children: [jsx("div", { style: borderStyle }), handles.map(({ position: pos, style }) => {
                ...
                return (jsx("div", { style: {
                        ...
                        ...style,
                        pointerEvents: 'auto',
                    }, onPointerDown: (e) => handlePointerDownWithFeedback(e, 'resize', pos), onContextMenu: (e) => e.preventDefault(), children: isMobile && (jsx("div", { style: getTouchTargetStyle(isMobile, pos), onPointerDown: (e) => {
                            e.stopPropagation();
                            handlePointerDownWithFeedback(e, 'resize', pos);
                        }, onContextMenu: (e) => e.preventDefault() })) }, pos));
            }), allowRotation && (jsxs(Fragment, { children: [jsx("div", { style: {
                            position: 'absolute',
                            top: stemTop,
                            left: '50%',
                            ...
                            transform: 'translateX(-50%)',
                            pointerEvents: 'auto',
                        }, onPointerDown: (e) => handlePointerDownWithFeedback(e, 'rotate'), onContextMenu: (e) => e.preventDefault(), children: isMobile && (jsx("div", { style: getTouchTargetStyle(isMobile, 'rotate'), onPointerDown: (e) => {
                                e.stopPropagation();
...
function LayerPanel({ images, selectedId, onSelect, onDelete, onReorder, onAddImage, currentView, onViewChange, compact = false, isMobile = false, hideAddButton = false }) {
    ...
    return (jsxs("div", { style: dynamicPanelStyle, children: [!compact && (jsx("div", { style: headerStyle, children: jsxs("div", { style: viewToggleContainerStyle, children: [jsxs("button", { style: getViewButtonStyle(currentView === "front"), onClick: () => onViewChange("front"), children: [jsx(FrontIcon, {}), "\u041E\u0442\u043F\u0440\u0435\u0434"] }), jsxs("button", { style: getViewButtonStyle(currentView === "back"), onClick: () => onViewChange("back"), children: [jsx(BackIcon, {}), "\u041E\u0442\u0437\u0430\u0434"] })] }) })), !hideAddButton && (jsx("div", { style: { padding: "12px 12px 4px" }, children: jsxs("button", { style: {
                    ...
                    const swipeOffset = (swipeState === null || swipeState === void 0 ? void 0 : swipeState.id) === image.id
                        ...
                        : 0;
                    return (jsxs("li", { style: getItemStyle(reversedIndex, isSelected, swipeOffset), onClick: () => !dragState && !swipeState && onSelect(image.id), onPointerDown: e => handleSwipeStart(e, image.id), onContextMenu: e => e.preventDefault(), children: [isMobile && swipeOffset < -20 && (jsx("div", { style: {
                                    position: "absolute",
                                    right: 0,
                                    top: 0,
                                    bottom: 0,
                                ...
                                }, children: jsx(DeleteIcon, {}) })), jsxs("div", { "data-drag-handle": true, style: getDragHandleStyle(isDragging), onPointerDown: e => {
                                    e.stopPropagation();
                                    handlePointerDown(e, reversedIndex);
                                }, onContextMenu: e => e.preventDefault(), children: [jsx("div", { style: getDragLineStyle() }), jsx("div", { style: getDragLineStyle() }), jsx("div", { style: getDragLineStyle() })] }), jsx("img", { src: image.src, alt: `Layer ${originalIndex + 1}`, style: thumbnailStyle, draggable: false, loading: "lazy", decoding: "async" }), jsxs("span", { style: labelStyle, children: ["\u0421\u043B\u043E\u0439 ", originalIndex + 1] }), jsx("button", { style: hoveredDeleteId === image.id ? deleteButtonHoverStyle : deleteButtonStyle, onClick: e => handleDelete(e, image.id), onMouseEnter: () => setHoveredDeleteId(image.id), onMouseLeave: () => setHoveredDeleteId(null), onPointerDown: e => e.stopPropagation(), title: "\u0418\u0437\u0442\u0440\u0438\u0439 \u0441\u043B\u043E\u0439", children: jsx(DeleteIcon, {}) })] }, image.id));
                }) }))] }));
}
...
function TShirtBuilder({ frontBgImage, backBgImage, backgrounds, initialBackgroundId, onBackgroundChange, config: configProp, responsive: responsiveProp, onChange, onExport, className, style, initialImages }) {
    ...
    // Mobile drawer state
    const [isPanelCollapsed, setIsPanelCollapsed] = useState((_a = responsiveConfig.mobileCollapsedByDefault) !== null && _a !== void 0 ? _a : true);
    ...
    const scaleTransform = useCallback((transform) => {
    ...
    return (jsxs("div", { ref: wrapperRef, className: className, style: { ...wrapperStyle, ...style }, children: [jsx("style", { children: `
          @keyframes spin {
        ...
        ` }), jsxs("div", { style: layoutContainerStyle, children: [jsx("div", { style: panelContainerStyle, children: layoutMode === 'vertical' ? (jsxs("div", { style: {
                                ...
                                overflow: 'hidden'
                                        ...
                                        borderBottom: `1px solid ${COLORS.LIGHT_GRAY}`
                                            ...
                                            borderRadius: '8px',
                                            padding: '4px'
                                        }, children: [jsxs("button", { onClick: () => setCurrentView('front'), style: {
                                                    flex: 1,
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    justifyContent: 'center',
                                                ...
                                                }, children: [jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("path", { d: "M20 21V19a4 4 0 00-4-4H8a4 4 0 00-4 4v2", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), jsx("circle", { cx: "12", cy: "7", r: "4", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })] }), "\u041E\u0442\u043F\u0440\u0435\u0434"] }), jsxs("button", { onClick: () => setCurrentView('back'), style: {
                                                    flex: 1,
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    justifyContent: 'center',
                                    ...
                                    }, children: [jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: {
                                                transform: isPanelCollapsed ? 'rotate(0deg)' : 'rotate(180deg)',
                                                transition: 'transform 0.3s ease-out'
                                            }, children: jsx("path", { d: "M4 6l4 4 4-4", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }), isPanelCollapsed ? 'Покажи слоевете' : 'Скрий слоевете'] }), jsx("div", { style: {
                                    ...
                                    boxSizing: "border-box"
                                            ...
                                            borderRadius: "10px"
                                                    ...
                                                    justifyContent: "center",
                                                    boxShadow: "0 2px 10px rgba(250, 192, 0, 0.2)"
                                                }, children: jsx("svg", { width: isMobileMode ? "28" : "24", height: isMobileMode ? "28" : "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: {
                                                        animation: "spin 1s linear infinite"
                                                    }, children: jsx("path", { d: "M12 2v4m0 12v4m-6-10H2m20 0h-4m-1.343-5.657l-2.829 2.829m-5.656 5.656l-2.829 2.829m11.314 0l-2.829-2.829m-5.656-5.656L4.686 6.343", stroke: COLORS.ACCENT, strokeWidth: "2", strokeLinecap: "round" }) }) }), jsx("span", { style: { fontWeight: 600, color: COLORS.DARK_GRAY, fontSize: isMobileMode ? "15px" : "14px" }, children: "\u041A\u0430\u0447\u0432\u0430\u043D\u0435..." }), jsx("div", { style: {
                                                    width: "80%",
                                                    maxWidth: "200px",
                                                    height: "6px",
                                                    backgroundColor: COLORS.LIGHT_GRAY,
                                                    ...
                                                    } }) }), uploadState.fileName && (jsx("span", { style: { color: COLORS.GRAY, fontSize: isMobileMode ? "13px" : "12px", maxWidth: "80%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: uploadState.fileName }))] })), displayConfig.printableArea && (jsx("div", { style: {
                                            position: "absolute",
                                        ...
                                        return (jsxs(React.Fragment, { children: [jsx("img", { src: imageData.src, alt: "\u041A\u0430\u0447\u0435\u043D \u0434\u0438\u0437\u0430\u0439\u043D", style: imageStyle, draggable: false, onPointerDown: e => {
                                                        handleMobileImageInteraction();
                                                        ...
                                                        handleMobileImageInteraction();
                                                    }, onContextMenu: e => e.preventDefault() }), isSelected && (jsx(Controls, { transform: scaledTransform, allowRotation: displayConfig.allowRotation || false, onPointerDown: (e, mode, handle) => handlePointerDown(e, imageData.id, mode, handle), isMobile: responsiveConfig.enabled && responsiveState.isMobile }))] }, imageData.id));
                                    }), displayConfig.printableArea && (jsx("div", { style: {
                                            position: "absolute",
                                            left: displayConfig.printableArea.minX,
                                            top: displayConfig.printableArea.minY,
                                            width: displayConfig.printableArea.maxX - displayConfig.printableArea.minX,
